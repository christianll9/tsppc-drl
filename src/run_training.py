...
from utils2 import torch_load_cpu

from problems import TSPPC
...
def run(opts):
    ...
    model = model_class(
        ...
        shared_keyvalues=opts.shared_keyvalues,
        pred2succ=opts.pred2succ,
        succ2pred=opts.succ2pred,
        pred_group=opts.pred_group,
        sparse_thresh=opts.sparse_thresh
    ).to(opts.device)
